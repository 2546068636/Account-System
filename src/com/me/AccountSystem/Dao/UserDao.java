...
public class UserDao {
	...
	public static boolean update(UserBean b) throws SQLException {
		QueryRunner qr = new QueryRunner(DBUtils.getDataSource());
		String sql = "update userbean set sex=?,phone=?,identity=?,password=?,account=? where name=?";
		int i = qr.update(sql,b.getSex(), b.getPhone(), b.getIdentity(), b.getPassword(), b.getAccount(),b.getName());
		if (i > 0) {
			return true;
		} else
			return false;
